...
const CustomerRow = ({ customer }) => {
    const { id, username, phoneNumber, address, roleName, email, counterId } =
        customer;
    ...
    const handleUpdateUser = async () => {
        try {
            const resUpdateAccount = await axios.put(
                `https://four-gems-system-790aeec3afd8.herokuapp.com/user/update?id=${id}`,
                {
                    id: id,
                    name: username,
                    userName: userName,
    ...
    const handleDeleteUser = async () => {
        try {
            await axios.delete(
                `https://four-gems-system-790aeec3afd8.herokuapp.com/user/delete?userId=${id}`,
                {
                    headers: {
