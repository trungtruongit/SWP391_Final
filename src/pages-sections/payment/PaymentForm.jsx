    ...
    const handleVNPay = async () => {
        try {
            const createVNPay = await axios.post(
                `https://four-gems-api-c21adc436e90.herokuapp.com/payment/vn-pay?amount=${VNDPrice}&bankCode=NCB&orderId=${orderId}`,
                VNPay,
                {
                    headers: {
    ...
    const handlePaypal = async () => {
        try {
            const createOrder = await axios.post(
                `https://four-gems-api-c21adc436e90.herokuapp.com/payment/paypal?orderId=${orderId}&total=${totalPrice}`,
                Paypal,
                {
                    headers: {
                        Authorization: "Bearer " + token,
    ...
    const handleCashod = async () => {
        try {
            const createCod = await axios.post(
                `https://four-gems-api-c21adc436e90.herokuapp.com/payment/cash?orderId=${orderId}`,
                orderId,
                {
                    headers: {
                        Authorization: "Bearer " + token,
        ...
        <Fragment>
            ...
            >
                <FormControlLabel
                    ...
                    label={<Paragraph fontWeight={600}>Pay with VN Pay</Paragraph>}
                    control={
                        <Radio
            ...
            <Grid container spacing={7}>
                ...
                <Grid item sm={6} xs={12}>
                    ...
                    <Button variant="contained" color="primary" type="button" fullWidth onClick={handleReviewClick}>
                        Review
                    </Button>
                </Grid>
            </Grid>
